...
class ViewController: UIViewController, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let nib = UINib(nibName: "RxSwiftTableViewCell", bundle: nil)
        tableView.register(nib, forCellReuseIdentifier: "RxSwiftTableViewCell")

        tableView.register(UITableViewCell.self, forCellReuseIdentifier: "RxSwiftTableViewCell")

        //elementはSectionModelの対応するitem
        dataSource.configureCell = { (_, table: UITableView, indexPath: IndexPath, element: String) in
            let cell = table.dequeueReusableCell(withIdentifier: "RxSwiftTableViewCell") as! RxSwiftTableViewCell
